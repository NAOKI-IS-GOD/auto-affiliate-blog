...
REVIEW_STYLE = """
    ...
    .article-hero { width: 100%; height: 300px; border-radius: var(--radius); display: flex; align-items: center; justify-content: center; font-size: 6rem; margin-bottom: 32px; }
...
<div style="background:var(--bg); padding: 20px;">
  <div class="review-page">
    ...
    <div class="article-hero" style="background:linear-gradient(135deg,{bg1.strip()},{bg2.strip()}); padding:0; overflow:hidden;">
      <img src="{img_url}" alt="{p['name']}" style="width:100%;height:100%;object-fit:cover;opacity:0.85;" loading="lazy">
    </div>
